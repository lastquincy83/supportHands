package com.supporthands.supportHands.config;
public class ApplicationConstants {
	...
	public static final String ADDED_NOTE_DESC="Successfully added new Note";
	public static final String UPDATED_NOTE_NOTEXIST_DESC="Note %s doesn't exist, Please provide correct details.";
	public static final String UPDATED_NOTE_DESC="Successfully updated Note.";
	public static final String NOTE_ID_NOTEXIST="Note doesn't exist. Please provide correct ids.";
	...
	public static final String VALIDATION_TITLE_EMPTY="Provide title";
}
